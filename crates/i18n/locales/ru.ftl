...
accounts-fees = Собранные комиссии
accounts-fees-hint = Сюда падают комиссии за переводы, если для них не выбран официальный счёт. Его нельзя переименовать или закрыть.
