...
web-nav-terms = Условия использования
web-nav-privacy = Конфиденциальность
web-nav-legal = Правовая информация
web-legal-meta-terms-title = Пользовательское соглашение — Noro
web-legal-meta-privacy-title = Политика конфиденциальности — Noro
web-legal-toc-title = Разделы документа
web-legal-updated = Редакция: { $date }
web-legal-lang = Язык документа:
web-legal-back = На главную
web-legal-copied = Ссылка на раздел скопирована
web-legal-print = Печать документа
web-legal-doc-terms = Пользовательское соглашение
...
web-legal-official-doc = Официальный юридический документ
...
cabinet-messages-title = Сообщения
cabinet-messages-lead = Ваши переписки — те же, что в игре
cabinet-messages-search = Поиск
cabinet-messages-none-title = Переписок пока нет
...
cabinet-messages-you = Вы
cabinet-messages-blocked = Вы заблокировали этого игрока. Писать вам он не может.
cabinet-messages-block = Заблокировать
cabinet-messages-unblock = Разблокировать
cabinet-messages-blocked-done = Заблокирован
cabinet-messages-unblocked-done = Разблокирован
cabinet-messages-from-site = Сайт
cabinet-messages-from-module = Модуль «{ $module }»
cabinet-messages-copy = Скопировать текст
cabinet-messages-copied = Скопировано
presence-in-game = в игре · { $server }
presence-in-game-short = в игре
presence-on-site = на сайте
presence-in-launcher = в лаунчере
presence-offline = оффлайн
presence-last-seen = был онлайн { $ago }
presence-never = здесь ещё не был
notif-direct-message = { $from } написал вам
...
admin-settings-tab-signing = Подпись
admin-settings-tab-health = Состояние
admin-signing-title = Цифровая подпись лаунчера
admin-signing-subtitle = Опциональная подпись бинарников лаунчера сертификатами разработчика (macOS Developer ID и Windows Authenticode)
admin-signing-macos-title = macOS (Apple Developer ID)
admin-signing-macos-desc = Позволяет запускать лаунчер на macOS без предупреждений Gatekeeper и сбоев Apple Silicon. Если сертификат не загружен, мастер автоматически подписывает бинарник ad-hoc подписью.
admin-signing-status-adhoc = Ad-hoc подпись (по умолчанию)
admin-signing-status-configured = Developer ID настроен
admin-signing-status-notarized = С нотаризацией Apple
admin-signing-p12-cert = Сертификат .p12 (Developer ID Application)
admin-signing-cert-pass = Пароль к сертификату
admin-signing-p8-key = Ключ App Store Connect API (.p8)
admin-signing-key-id = Key ID (например, 2X9R4HXF34)
admin-signing-issuer-id = Issuer ID (UUID из App Store Connect)
admin-signing-windows-title = Windows (Authenticode)
admin-signing-windows-desc = Подпись исполняемых файлов .exe для снижения предупреждений Windows Defender SmartScreen. Если сертификат не загружен, файлы остаются неподписанными.
admin-signing-status-unsigned = Без подписи (по умолчанию)
admin-signing-status-authenticode = Authenticode настроен
admin-signing-pfx-cert = Сертификат .pfx / .p12
admin-signing-timestamp-url = URL сервера штампа времени (Timestamp Server)
admin-signing-upload-btn = Сохранить настройки
admin-signing-delete-btn = Удалить
admin-signing-delete-confirm = Удалить сертификат для этой платформы?
admin-signing-enable-toggle = Включить подпись
admin-signing-choose-file = Выбрать файл...
admin-signing-file-selected = Выбран файл: { $name }
admin-signing-pass-placeholder = Оставьте пустым, чтобы не менять
admin-signing-notary-title = Нотаризация Apple (App Store Connect API)
admin-signing-p12-current = Сертификат .p12 уже загружен на сервер
admin-signing-p8-current = Ключ .p8 уже загружен на сервер
admin-signing-pfx-current = Сертификат Authenticode уже загружен на сервер
admin-legal-card-title = Юридические документы
admin-legal-card-desc = Настройка текста Пользовательского соглашения и Политики конфиденциальности проекта
admin-legal-doc-select = Документ
admin-legal-doc-terms = Пользовательское соглашение (Terms)
admin-legal-doc-privacy = Политика конфиденциальности (Privacy)
admin-legal-locale-select = Язык
admin-legal-badge-default = Стандартный шаблон
admin-legal-badge-custom = Собственный текст
admin-legal-reset-btn = Сбросить до стандартного
admin-legal-reset-confirm = Сбросить документ к исходному шаблону? Ваши изменения будут удалены.
admin-legal-mode-edit = Редактор
admin-legal-mode-preview = Рендер секций
admin-legal-save-btn = Сохранить документ
admin-legal-view-btn = Открыть на сайте
...
cabinet-activity-month = за месяц
...
perm-node-modules-view = Просмотр установленных модулей
perm-node-modules-install = Установка и обновление модулей
perm-node-modules-enable = Включение и выключение модулей
perm-node-modules-settings = Изменение настроек модулей
perm-node-modules-delete = Удаление модулей вместе с их данными
...
nav-hub-feed = Лента
nav-hub-members = Участники
nav-hub-moderation = Модерация
nav-hub-bank = Банк
nav-hub-banker = Кабинет банкира
nav-hub-courts = Суды
nav-hub-petitions = Петиции
nav-hub-back = Вернуться в кабинет

## Подсайт сервера: каркас и доступ
hub-title-fallback = Подсайт сервера
hub-online-now = В игре: { $count }
hub-online-nobody = Сейчас никого нет в игре
hub-my-hubs = Мои серверы
hub-my-hubs-empty = Вы пока не состоите ни в одном подсайте
hub-open = Открыть подсайт
hub-access-denied-title = Нет доступа к подсайту
hub-access-denied-text = Подсайт открыт только игрокам этого сервера.
hub-not-found-title = Подсайт не найден
hub-not-found-text = Неверный адрес или подсайт выключен.
hub-archived-notice = Сервер в архиве. Подсайт можно читать, но не писать в него.
hub-feature-off-title = Раздел выключен
hub-feature-off-text = Владелец сервера не включил этот раздел.

## Подсайт сервера: лента
hub-feed-title = Лента
hub-feed-empty-title = Записей пока нет
hub-feed-empty-text = Напишите первым.
hub-feed-placeholder = Расскажите что-нибудь серверу
hub-feed-publish = Опубликовать
hub-feed-attach = Прикрепить картинку
hub-feed-images-left = Можно прикрепить ещё { $count }
hub-feed-too-long = Запись длиннее { $max } символов
hub-feed-cooldown = Следующая запись через { $seconds } с
hub-feed-muted = Вы в муте на этом сервере до { $until }
hub-feed-muted-forever = Вы в муте на этом сервере
hub-feed-archived = Сервер в архиве, публикация закрыта
hub-post-edited = изменено
hub-post-pinned = Закреплено
hub-post-pinned-bought = Продвигается
hub-post-pin = Закрепить сверху
hub-post-actions = Действия с записью
hub-post-unpin = Открепить
hub-ad-badge = Реклама
card-input-empty = Нет карты для оплаты
hub-ad-prev = Предыдущая реклама
hub-ad-next = Следующая реклама
hub-ad-remove = Снять эту рекламу
hub-promote-action = Продвинуть запись
hub-promote-remove = Снять продвижение
hub-promote-removed = Продвижение снято
hub-promote-title = Продвижение записи
hub-promote-subtitle = Держать её сверху ленты или показать в карусели
hub-promote-kind-pin = Закрепить сверху
hub-promote-kind-ad = Рекламная карусель
hub-promote-pin-hint = Запись держится над лентой до конца оплаченного времени. Закреплённое сервером всегда выше.
hub-promote-ad-hint = Запись попадает в карусель над лентой: первая картинка и начало текста.
hub-promote-hours = Часов
hub-promote-days = Дней
hub-promote-total = К оплате { $total }
hub-promote-free = Продвижение на этом сервере бесплатное
hub-promote-confirm = Оплатить и продвинуть
hub-promote-done = Продвигается до { $until }
hub-promote-remove-pin = Запись вернётся на своё место в ленте.
hub-promote-remove-ad = Запись уйдёт из карусели.
hub-promote-reason = Причина
hub-promote-refund = Вернуть деньги
hub-promote-refund-hint = Возвращается вся сумма обратной проводкой. Не отмечайте, если продвижение снято за нарушение.
hub-promote-remove-confirm = Снять
hub-post-edit = Изменить
hub-post-save = Сохранить
hub-post-delete = Удалить
hub-post-delete-confirm = Удалить запись? Это необратимо.
hub-post-hidden-badge = Скрыто
hub-post-hidden-note = Скрыто модератором: { $reason }
hub-post-open = Открыть запись
hub-post-not-found = Запись не найдена

## Подсайт сервера: комментарии и реакции
hub-comments-title = Комментарии
hub-comments-empty = Комментариев пока нет
hub-comments-more = Ещё комментариев: { $n }
hub-comment-placeholder = Написать комментарий
hub-comment-send = Отправить
hub-comment-delete = Удалить
hub-comment-delete-confirm = Удалить комментарий?
hub-comment-hidden = Комментарий скрыт модератором
hub-reaction-like = Нравится
hub-reaction-unlike = Убрать отметку

## Подсайт сервера: жалобы
hub-report-action = Пожаловаться
hub-report-title = Жалоба на запись
hub-report-reason = Причина
hub-report-placeholder = Что с ней не так?
hub-report-send = Отправить жалобу
hub-report-sent = Жалоба отправлена модераторам
hub-report-already = Вы уже жаловались на это

## Подсайт сервера: модерация
hub-moderation-title = Модерация
hub-moderation-queue = Открытые жалобы
hub-moderation-empty-title = Разбирать нечего
hub-moderation-empty-text = Открытых жалоб на этом подсайте нет.
hub-moderation-hide = Скрыть
hub-moderation-unhide = Вернуть
hub-moderation-hide-title = Скрыть запись
hub-moderation-hide-reason = Причина, которую увидит автор
hub-moderation-uphold = Удовлетворить
hub-moderation-dismiss = Отклонить
hub-moderation-reported-by = Пожаловался { $name }
hub-moderation-status-open = Открыта
hub-moderation-status-upheld = Удовлетворена
hub-moderation-status-dismissed = Отклонена

## Подсайт сервера: участники и профиль
hub-members-title = Участники
hub-members-search = Поиск игроков
hub-members-empty-title = Участников пока нет
hub-members-empty-text = На этом сервере ещё никто не играл.
hub-members-first-seen = Впервые { $date }
...
hub-profile-about-empty = Здесь пока пусто
hub-profile-about-save = Сохранить
hub-profile-posts = Записи
hub-profile-posts-empty = Записей пока нет
hub-profile-roles = Роли
hub-profile-stats = Статистика
hub-profile-played-total = Всего
hub-profile-played-month = Месяц
hub-profile-played-week = Неделя
hub-profile-played-today = Сегодня
hub-profile-hours = { $hours } ч
hub-profile-activity = Активность на этом сервере

## Подсайт сервера: банк
bank-title = Банк
bank-my-cards = Мои карточки
bank-no-cards-title = Карточек пока нет
bank-no-cards-text = Выпустите карточку, чтобы хранить деньги и получать переводы.
bank-issue = Выпустить карточку
bank-issue-title = Новая карточка
bank-issue-label = Название карточки
bank-issue-label-hint = Для себя: «на траты», «казна города»
bank-issue-price = Цена выпуска: { $price }
bank-issue-first-free = Первая карточка бесплатна
bank-issue-pay-from = Оплатить с
bank-card-number = Номер
bank-card-closed = Закрыта
bank-card-close = Закрыть карточку
bank-card-close-confirm = Закрыть карточку? У новой будет другой номер.
bank-card-too-young = Эту карточку ещё рано закрывать
bank-card-primary = Основная
bank-card-make-primary = Сделать основной для переводов по нику
bank-card-image = Оформление
bank-card-image-clear = Снять картинку
bank-card-image-price = Цена оформления: { $price }
bank-card-image-removed = Картинка снята
bank-cards-limit = У вас уже максимум карточек
bank-copy-number = Скопировать номер
bank-copied = Номер скопирован
bank-transfer = Перевод
bank-transfer-title = Отправить деньги
bank-transfer-from = С карточки
bank-transfer-to = На номер карточки
bank-transfer-to-any = Номер карточки или ник
bank-transfer-amount = Сумма
bank-transfer-comment = Пометка
bank-transfer-fee = Комиссия: { $fee } — только между картами игроков
bank-transfer-send = Отправить
bank-transfer-done = Перевод отправлен
bank-transfer-limit = Не больше { $max } за перевод
bank-no-primary = Игрок не выбрал карточку для переводов по нику
bank-not-enough = На карточке недостаточно денег
bank-history = История
bank-history-empty = Операций пока нет
bank-transactions = Транзакции
bank-op-deposit = Внесение
bank-op-withdraw = Снятие
bank-op-transfer = Перевод
bank-op-issue = Выпуск карточки
bank-op-fine = Штраф
bank-op-refund = Возврат
bank-op-town = Пошлина города
bank-op-court = Судебная пошлина
bank-op-petition = Пошлина петиции
bank-op-promo = Продвижение
bank-op-community = Пошлина сообщества
bank-op-market = Рынок
bank-op-payout = Выплата за продажу
bank-op-shipping = Доставка
bank-op-courier = Выплата курьеру
bank-receipt-packs = { $packs } × { $price } ({ $items } шт)
bank-receipt-fee = комиссия { $fee }
bank-party-treasury = Казна сервера
bank-party-fees = Доход банка
bank-party-escrow = Счёт сделок
bank-refund = Вернуть
bank-refund-reason = Почему операция возвращается?
bank-refund-done = Возврат проведён

## Подсайт сервера: кабинет банкира
banker-title = Кабинет банкира
banker-search = Ник игрока или номер карточки
banker-search-empty = Ничего не найдено
banker-owner = Владелец
banker-deposit = Внести
banker-withdraw = Снять
banker-withdraw-denied = Этому игроку карта открыта только на просмотр
banker-group-own = Его карточки
banker-group-town = Казна города
banker-group-shared = Открыты ему
banker-group-official = Счета структур
banker-group-closed = Закрытые ({ $count })
banker-amount = Сумма
banker-comment = Основание
banker-comment-hint = Видно в журнале сервера
banker-confirm-deposit = Внести { $amount } на карточку { $number }?
banker-confirm-withdraw = Снять { $amount } с карточки { $number }?
banker-done = Операция проведена
banker-ledger = Операции сервера
banker-summary = Деньги на сервере
banker-in-circulation = В обороте
banker-backing = Должно лежать в хранилище
banker-backing-hint = Столько банк должен игрокам: ровно столько монет обязано физически лежать в хранилище.
banker-fees = Доход банка
banker-official = На счетах структур
banker-cards = Открытых карточек
banker-balanced = Счета сходятся
banker-not-balanced = Счета не сходятся — { $delta }

## Админка: подсайт сервера
admin-hub-tab = Подсайт
admin-hub-tab-hint = Лента, профили и разделы сообщества
admin-hub-title = Подсайт сервера
admin-hub-subtitle = Сайт сообщества этого сервера: лента, профили и остальное
admin-hub-enabled = Подсайт включён
admin-hub-enabled-hint = Выключенный подсайт скрыт от игроков, но ничего не удаляется
admin-hub-address = Адрес
admin-hub-address-hint = Строчные латинские буквы, цифры и дефисы
admin-hub-address-taken = Этот адрес уже занят
admin-hub-address-reserved = Этот адрес зарезервирован сайтом
admin-hub-address-invalid = Только строчные латинские буквы, цифры и дефисы
admin-hub-address-change-confirm = Сменить адрес? Все уже разосланные ссылки перестанут работать.
admin-hub-name = Название подсайта
admin-hub-name-hint = Как сервер называет сам себя
admin-hub-tagline = Подпись
admin-hub-open = Открыть подсайт
admin-hub-events = Журнал подсайта
admin-hub-save = Сохранить
admin-hub-saved = Настройки подсайта сохранены
admin-hub-features = Разделы
admin-hub-feature-feed = Лента
admin-hub-feature-feed-hint = Игроки пишут записи в общую ленту сервера
admin-hub-feature-profiles = Профили
admin-hub-feature-profiles-hint = Страницы игроков с ролями и наигранным временем
admin-hub-feature-bank = Банк
admin-hub-feature-bank-hint = Валюта сервера, счета и переводы
admin-hub-feature-courts = Суды
admin-hub-feature-courts-hint = Иски и разбирательства между игроками
admin-hub-feature-petitions = Петиции
admin-hub-feature-petitions-hint = Петиции игроков с подписями
admin-hub-feature-towns = Карта
admin-hub-feature-towns-hint = Города и карта сервера
admin-hub-feature-ads = Реклама
admin-hub-feature-ads-hint = Платная карусель над лентой
admin-hub-settings = Настройки разделов
admin-hub-settings-hint = Настройки появляются здесь по мере включения разделов
admin-hub-value-invalid = Значение вне допустимых границ
admin-hub-settings-feed = Лента
admin-hub-set-post-max = Предел длины записи
admin-hub-set-images-max = Картинок на запись
admin-hub-set-cooldown = Секунд между записями
admin-hub-set-pin-price = Цена часа закрепа
admin-hub-set-pin-max-hours = Предел закрепа, часов
admin-hub-set-pin-slots = Купленных закрепов сразу
admin-hub-settings-ads = Реклама
admin-hub-set-ad-price = Цена дня рекламы
admin-hub-set-ad-max-days = Предел рекламы, дней
admin-hub-set-ad-slots = Карточек в карусели
admin-hub-set-ad-payee = Счёт доходов от рекламы
admin-hub-settings-currency = Валюта
admin-hub-set-currency-name = Название валюты
admin-hub-set-currency-symbol = Символ
admin-hub-set-currency-precision = Знаков после запятой
admin-hub-set-currency-start = Стартовый баланс
admin-hub-settings-bank = Банк
admin-hub-set-card-price = Цена выпуска карточки
admin-hub-set-card-image-price = Цена картинки на карточке
admin-hub-set-plus-price = Цена улучшения
admin-hub-set-plus-transfer-max = Предел перевода, улучшенная
admin-hub-set-fees-account = Комиссии идут на
admin-hub-set-fees-account-hint = «Оставлять в банке» — это отдельный счёт сборов, а не казна: казна лишь показывает, сколько банк должен игрокам.
admin-hub-set-petition-payee = Пошлина идёт на
admin-hub-set-petition-payee-hint = «Оставлять в банке» — деньги уйдут в казну, то есть уменьшат долг банка, а не достанутся кому-то.
admin-hub-set-claim-payee = Пошлина идёт на
admin-hub-set-claim-payee-hint = «Оставлять в банке» — деньги уйдут в казну, то есть уменьшат долг банка, а не достанутся кому-то.
admin-hub-set-town-payee = Плата идёт на
admin-hub-set-town-payee-hint = «Оставлять в банке» — деньги уйдут в казну, то есть уменьшат долг банка, а не достанутся кому-то.
bank-tier-plus = Улучшенная
bank-card-official = Служебный
bank-card-shared = Карта { $name }
accounts-number-edit = Номер
accounts-number-hint = Куда переводят на этот счёт. Пусто — переводов по номеру нет.
accounts-number-taken = Этот номер уже занят
card-access-title = Кто пользуется картой
card-skin-title = Оформление карты
card-skin-empty = У сервера пока нет фонов
card-skin-none = Без фона
card-skin-own = Загрузить свою
card-skin-own-price = Загрузить свою за { $price }
card-skin-own-needs-plus = Своя картинка — для улучшенной карты
card-access-hint = Вы делитесь картой { $number }. Владелец по-прежнему вы — доступ можно забрать в любой момент.
card-access-empty = Больше ни у кого нет доступа
card-access-add = Игрок
card-access-level = Доступ
card-access-view = Смотреть
card-access-spend = Тратить
card-access-grant = Дать доступ
card-access-revoke = Забрать
bank-upgrade = Улучшить
bank-upgrade-price = Улучшить за { $price }
bank-upgrade-done = Карта улучшена
bank-upgrade-perks = Без комиссии, выше предел перевода, своя картинка
admin-hub-set-max-cards = Карточек на игрока
admin-hub-set-card-min-age = Дней до закрытия карточки
admin-hub-set-transfer-fee = Комиссия перевода, %
admin-hub-set-transfer-max = Предел перевода
admin-hub-settings-petitions = Петиции
admin-hub-set-petition-price = Цена подачи
admin-hub-set-petition-votes = Нужно подписей
admin-hub-set-petition-days = Дней на сбор
admin-hub-settings-courts = Суды
admin-hub-set-claim-price = Цена иска
admin-hub-set-claim-days = Дней на рассмотрение
admin-hub-settings-towns = Города
admin-hub-set-town-price = Цена основания города
admin-hub-audit-all = Все серверы
admin-hub-audit-global = Глобальные
admin-hub-event-post-hidden = Запись скрыта
admin-hub-event-post-unhidden = Запись возвращена
admin-hub-event-post-pinned = Запись закреплена
admin-hub-event-post-unpinned = Запись откреплена
admin-hub-event-post-deleted = Запись удалена
admin-hub-event-promo-bought = Куплено продвижение
admin-hub-event-promo-cancelled = Продвижение снято
admin-hub-event-comment-hidden = Комментарий скрыт
admin-hub-event-report-opened = Подана жалоба
admin-hub-event-report-upheld = Жалоба удовлетворена
admin-hub-event-report-dismissed = Жалоба отклонена
admin-hub-event-settings = Изменены настройки подсайта
admin-hub-event-slug = Изменён адрес подсайта

## Права: подсайт сервера
perm-node-hub-view = Просмотр вкладки подсайта и его журнала
perm-node-hub-edit = Изменение подсайта, разделов и настроек
perm-node-hub-moderate = Модерация содержимого подсайта
perm-node-hub-pin = Закрепление записей в ленте

## Восстановлено из собранного каталога
admin-case-ticket = Разговор с игроком
admin-case-ticket-open = Написать игроку
admin-perm-locked-hint = Роль сборки выдаёт права только на ней.
admin-role-badge-text-color-hint = Пусто — белые или чёрные, по яркости фона.
admin-roles-group-global = Весь проект
admin-roles-order-unused = Не используется: роль, показанная отдельно, ни с кем не соревнуется.
admin-roles-scope-global = Весь проект
admin-roles-standalone = Показывать отдельно
admin-roles-standalone-hint = Видна рядом со старшей ролью, а не вместо неё. Для ролей вне лестницы: Банкир, ФБР.
admin-tickets-close = Закрыть
admin-tickets-link-case = Привязать к делу
admin-tickets-none-text = Под этот фильтр ничего не ждёт ответа.
admin-tickets-pick-text = Переписка откроется здесь.
admin-tickets-search = Игрок или тема
admin-tickets-title = ПОДДЕРЖКА
admin-tickets-unlink = Отвязать от дела
admin-tokens-owner-none = Ничей
admin-users-roles-hint = Что игроку доступно в админке и в игре.
admin-users-roles-none-hint = У игрока только права, которые есть у любого аккаунта.
atom-file-wrong-type = { $name } — неподходящий тип файла
bank-card-image-set = Поставить картинку
bank-out = расход
bank-transfer-total = Спишется: { $total }
cabinet-support-message = Сообщение
cabinet-support-new-hint = Расскажите, что случилось. Ответ придёт сюда и в игру.
cabinet-support-none-title = Обращений нет
cabinet-support-subtitle = Спросить персонал, обжаловать наказание, сообщить о проблеме
nav-cabinet-messages = Сообщения
nav-cabinet-support = Поддержка
nav-group-players = Игроки
nav-group-servers = Серверы
perm-node-tickets-close = Закрывать и переоткрывать обращения
perm-node-tickets-view = Читать обращения игроков
...
admin-roles-group-unknown = Сборка удалена
admin-roles-order-hint = Больше — важнее: роль потяжелее закрывает собой ту, что легче.
admin-roles-scope = Где действует
admin-roles-scope-hint = Роль сборки работает только на ней — и права, и плашка, и то, кому её можно выдавать.
admin-roles-standalone-short = отдельно
admin-set-description = Описание
admin-tickets-case = Дело N-{ $number }
admin-tickets-link-none = Дел по этому игроку нет.
admin-tickets-none-title = Очередь пуста
admin-tickets-pick-title = Выберите обращение
admin-tickets-subtitle = Обращения игроков и разговоры из дел
admin-tokens-owner = Действует от имени
admin-tokens-owner-hint = Чьим именем подписано сделанное токеном. Прав человека токен не получает — они у него свои. В журнале действие помечается как сделанное токеном.
admin-users-roles-none = Ролей нет
admin-users-roles-not-yours = Эту роль вам выдавать нельзя.
atom-file-too-large = { $name } — больше { $limit } МБ
cabinet-support-new = Новое обращение
cabinet-support-none-text = Напишите, если нужен персонал.
cabinet-support-send = Отправить
cabinet-support-subject = Тема
cabinet-support-title = ПОДДЕРЖКА
nav-admin-tickets = Поддержка
nav-group-moderation = Модерация
nav-group-overview = Главное
tickets-closed-note = Разговор закрыт. Если осталось недосказанное — заведите новое обращение.
tickets-empty-title = Пока ничего не сказано
banker-pick-card = Выберите карточку для работы
banker-desk = Касса
banker-recent = Последние операции
banker-balance = Баланс
banker-search-hint = Ник, или номер карточки, если он есть
banker-cleared-image = Картинка снята банком

## Подсайт сервера: штрафы
nav-hub-fines = Штрафы
nav-hub-accounts = Служебные счета
accounts-title = Официальные счета
accounts-hint = Казна города, полиции, суда. Доступ выдаётся ролями.
accounts-empty = Счетов пока нет
accounts-fees = Доход банка
accounts-fees-hint = Сюда падают комиссии и плата за карты, если для них не выбран официальный счёт. Его нельзя переименовать или закрыть.
accounts-add = Новый счёт
accounts-code = Код
accounts-code-hint = Попадает в узел права и потом не меняется
accounts-label = Название
accounts-number = Выдать номер
accounts-created = Счёт создан
accounts-rename = Переименовать
accounts-close = Закрыть
accounts-close-confirm = Закрыть счёт? История по нему останется.
accounts-closed = Закрыт
accounts-roles = Кому доверен счёт
accounts-roles-empty = Пока ни у одной роли нет доступа
accounts-roles-global = Общая роль
accounts-roles-show = Показать все роли
accounts-roles-hide = Только с доступом
accounts-hidden-balance = Баланс недоступен
accounts-spend = Перевести
accounts-spend-to = Карта или ник
accounts-spend-amount = Сумма
accounts-spend-comment = Комментарий
accounts-spend-done = Перевод отправлен
accounts-history = Выписка
fines-title = Штрафы
fines-mine = Мои штрафы
fines-none-title = Штрафов нет
fines-none-text = Платить нечего.
fines-due = Оплатить до { $date }
fines-no-due = Без срока
fines-overdue = Просрочен
fines-overdue-count = Просрочено: { $count }
fines-status-unpaid = Не оплачен
fines-status-paid = Оплачен
fines-status-cancelled = Отменён
fines-pay = Оплатить
fines-pay-from = Оплатить с карточки
fines-paid-done = Штраф оплачен
fines-issued-by = Выписал { $name }
fines-issue = Выписать штраф
fines-issue-target = Ник игрока
fines-issue-amount = Сумма
fines-issue-reason = Основание
fines-payee = Деньги идут на
fines-payee-hint = Счёт, который получит штраф
fines-payee-treasury = Казна сервера
fines-issue-done = Штраф выписан
fines-cancel = Отменить
fines-cancel-confirm = Отменить штраф?
fines-all = Все штрафы
fines-history = Закрытые штрафы
fines-no-reason = Без причины
fines-owed = На вас { $amount }
admin-hub-feature-fines = Штрафы
admin-hub-feature-fines-hint = Персонал штрафует игроков; оплата с карточки
admin-hub-feature-needs = Нужен раздел «{ $base }»
admin-hub-setting-needs = Платным только с разделом «{ $base }»
admin-hub-skins = Фоны карт
admin-hub-skins-hint = Набор, из которого выбирают игроки. Своя картинка игрока сюда не попадает.
admin-hub-skins-empty = Фонов пока нет
admin-hub-skin-add = Добавить фон
admin-hub-skin-remove = Убрать
admin-hub-skin-remove-confirm = Убрать фон? Карты с ним вернутся к простому виду.
admin-hub-account-default = Оставлять в банке
account-view = Смотреть
account-spend = Тратить
account-manage = Управлять
fines-issue-page = Выписка штрафов
fines-tab = Штрафы
bank-tab-account = Счёт
fines-filter-all = Все
fines-nothing-to-pay = Нечего оплачивать
admin-hub-settings-fines = Штрафы
admin-hub-set-fine-due-days = Дней на оплату
admin-hub-set-fine-max = Предел штрафа
...
map-search = Поиск городов
map-layers = Слои
map-layer-towns = Границы городов
map-layer-labels = Названия городов
map-layer-disputes = Спорные чанки
map-layer-markers = Метки сервера
map-layer-players = Игроки онлайн
map-layer-grid = Сетка чанков
map-open = Показать на карте
map-home = В центр
map-no-towns = Городов здесь пока нет
towns-claim-on-map = Занять на карте
towns-land-chunks = чанков
towns-land-free = из них бесплатно: { $free }
towns-founded-at = Основан
player-input-placeholder = Найти игрока
player-input-clear = Очистить
accounts-search = Название, код или номер
accounts-search-empty = Ничего не нашлось
accounts-tab-server = Сервер
accounts-tab-towns = Города
towns-emblem = Герб
towns-banner = Баннер
...
ministry-my-rights = Мои права минюста
ministry-right-approve = Заявки
ministry-right-create = Заводить города
ministry-right-edit = Править города
ministry-right-land = Править границы
...
map-mark = Метка сервера
map-mark-hint = Кликните по карте, чтобы поставить метку
map-mark-label = Название метки
map-mark-add = Поставить
ministry-show-dissolved = Показывать распущенные
towns-leave = Выйти из города
towns-leave-mayor = Сначала передайте пост мэра
towns-rename = Переименовать город
admin-hub-set-town-rename = Мэр может переименовать город
admin-hub-set-town-rename-hint = Выключено — имя меняет только минюст
map-paint-hint = Ведите мышью, чтобы выделить чанки; с Shift — прямоугольник
map-claim-done = Занято: { $taken }
map-claim-partial = Занято { $taken }, отказано { $refused }
...
court-none = Дел пока нет
court-filter-open = Открытые
court-filter-mine = Мои
court-filter-all = Все
court-file = Подать иск
court-filed = Иск подан
court-kind = Вид иска
court-kind-player = Игрок против игрока
court-kind-town = Город против города
court-kind-structure = Иск к структуре
court-kind-fine_appeal = Обжалование штрафа
court-title = Существо спора
court-body = Что случилось
court-plaintiff = Истец
court-defendant = Ответчик
court-defendant-town = Город-ответчик
court-as-town = Подаётся от имени { $name }
court-need-town = Вы не ведёте город
court-price = Подача стоит { $price }
court-hint = Суд двигает деньги и территорию. Баны и муты остаются у модерации.
court-status-filed = Ждёт судью
court-status-hearing = Слушается
court-status-decided = Решено
court-status-dismissed = Отказано
court-status-withdrawn = Отозван
court-overdue = Просрочено
court-judge-is = Судья { $name }
court-deadline = Решить до
court-take = Взять дело
court-withdraw = Отозвать
court-thread = Протокол
court-thread-empty = Пока никто ничего не сказал
court-say = Ваши слова
court-send = Сказать
court-chamber = Совещательная
court-chamber-write = Записать в совещательную
court-decide = Вынести решение
court-dismiss = Отказать
court-ruling = Решение
court-award = Взыскание
court-grant-chunks = Передать спорную землю
court-cancel-fine = Отменить штраф
court-moved-chunks = Передано чанков: { $count }
court-fine-cancelled = Штраф отменён
court-award-hint = Выписывает штраф ответчику; городу — его мэру
court-parties = Действующие лица
court-judge = Судья дела
court-judge-none = Не выбран
court-not-a-party = Вы не являетесь участником дела
town-input-placeholder = Найти город
court-attach = Прикрепить

nav-hub-group-community = Сообщество
nav-hub-group-public = Сервер
nav-hub-group-staff = Служебное

admin-hub-set-petition-playtime = Часов игры для подписи

petition-none = Петиций пока нет
petition-filter-open = Идёт сбор
petition-filter-answered = Отвеченные
petition-filter-all = Все
petition-file = Подать петицию
petition-filed = Петиция подана
petition-target = Кому адресована
petition-target-server = Администрации
petition-target-town = Городу
petition-target-account = Структуре
petition-target-town-pick = Какому городу
petition-target-account-pick = Какой структуре
petition-title = Суть
petition-body = Что вы просите
petition-price = Подача стоит { $price }
petition-hint = Петиции нужно { $votes } подписей за { $days } дней, после этого адресат обязан ответить.
petition-status-collecting = Идёт сбор
petition-status-answering = Ждёт ответа
petition-status-answered = Отвечена
petition-status-expired = Просрочена
petition-status-withdrawn = Отозвана
petition-votes = { $votes } из { $needed }
petition-sign = Подписать
petition-unsign = Отозвать подпись
petition-signatures = Подписи
petition-signatures-none = Пока никто не подписал
petition-deadline = Сбор до { $date }
petition-author = Подал { $name }
petition-answer = Ответ
petition-answer-give = Ответить на петицию
petition-answered-by = Ответил { $name }
...
# Сообщества подсайта.
nav-hub-communities = Сообщества

admin-hub-feature-communities = Сообщества
admin-hub-feature-communities-hint = Группы игроков, которые пишут в ленту от своего имени
admin-hub-settings-communities = Сообщества
admin-hub-set-community-mode = Как заводят сообщества
admin-hub-set-community-mode-free = Игроки заводят сами
admin-hub-set-community-mode-application = Игроки подают заявку, штаб одобряет
admin-hub-set-community-mode-staff = Заводит только штаб
admin-hub-set-community-price = Цена основания
admin-hub-set-community-payee = Куда идёт пошлина
admin-hub-set-community-per-user = Сообществ на игрока
admin-hub-set-community-playtime = Часов игры до основания
admin-hub-set-community-name-max = Предел длины названия
admin-hub-set-community-desc-max = Предел длины описания

hub-communities-title = Сообщества
hub-communities-empty-title = Сообществ пока нет
hub-communities-empty-text = Заведите первое на этом сервере.
hub-communities-search = Поиск по названию
hub-communities-mine = Мои сообщества
hub-communities-all = Все
hub-community-create = Создать сообщество
hub-community-created = Сообщество готово
hub-community-requested = Заявка отправлена, штаб её рассмотрит
hub-community-name = Название
hub-community-slug = Адрес
hub-community-description = Описание
hub-community-avatar = Аватар
hub-community-banner = Баннер
hub-community-save = Сохранить
hub-community-edit = Настроить
hub-community-saved = Сохранено
hub-community-subscribe = Подписаться
hub-community-unsubscribe = Отписаться
hub-community-subscribers = { $count } подписчиков
hub-community-posts = { $count } записей
hub-community-verified = Подтверждено сервером
hub-community-verify = Подтвердить
hub-community-unverify = Снять галочку
hub-community-block = Заморозить
hub-community-unblock = Разморозить
hub-community-dissolve = Закрыть сообщество
hub-community-dissolve-confirm = Записи останутся читаемыми, но из ленты сообщество исчезнет.
hub-community-town = Город
hub-community-town-none = Не городское сообщество
hub-community-staff = Штаб
hub-community-staff-owner = Владелец
hub-community-staff-editor = Редактор
hub-community-staff-add = Добавить редактора
hub-community-staff-remove = Убрать из штаба
hub-community-hand-over = Передать сообщество
hub-community-hand-over-hint = Вы станете редактором, он — владельцем.
hub-community-post-as = Писать от имени
hub-community-post-as-me = Себя
hub-community-posted-by = Написал { $name }
hub-community-status-pending = Ждёт одобрения
hub-community-status-active = Работает
hub-community-status-blocked = Заморожено
hub-community-status-dissolved = Закрыто
hub-community-applications = Заявки на сообщества
hub-community-applications-empty = Заявок нет
hub-community-approve = Одобрить
hub-community-reject = Отклонить
hub-community-limit-reached = У вас уже столько сообществ, сколько разрешает сервер
hub-community-inactive = Сообщество не работает
hub-community-wall-empty = Здесь ещё ничего не написали

nav-hub-market = Рынок

admin-hub-feature-market = Рынок
admin-hub-feature-market-hint = Игроки продают предметы друг другу, а сервер держит оплату до закрытия сделки
admin-hub-settings-market = Рынок
admin-hub-set-market-storage = Где лежит товар
admin-hub-set-market-storage-vanilla = В бочках, которые построили игроки
admin-hub-set-market-storage-vault = В виртуальном хранилище
admin-hub-set-market-listing-price = Пошлина за выставление лота
admin-hub-set-market-fee = Доля сервиса с продажи, проценты
admin-hub-set-market-stock-hours = Часов на закладку товара
admin-hub-set-market-lot-days = Дней лот висит на витрине
admin-hub-set-market-lots-per-seller = Лотов на продавца
admin-hub-set-market-packs-per-point = Порций одного продавца на одном пункте
admin-hub-set-market-occupancy = Насколько сильно обходится занятый пункт
admin-hub-set-market-strike-window = За сколько дней считаются страйки
admin-hub-set-market-strikes-to-ban = Сколько страйков закрывают торговлю
admin-hub-set-market-ban-days = На сколько дней закрывается торговля

hub-market-title = Рынок
hub-market-empty-title = Пока ничего не продают
hub-market-empty-text = Выставьте что-нибудь первым на этом сервере.
hub-market-search = Поиск по предмету
hub-market-mine = Мои лоты и заказы
hub-market-points = Пункты хранения
hub-market-sell = Выставить предмет
hub-market-price-each = За порцию
hub-market-packs-left = Осталось порций
hub-market-buy = Купить
hub-market-stocking = Ждёт закладки
hub-market-put-here = Положите товар в эти бочки
hub-market-pick-up = Забрать здесь
hub-market-collected = Я забрал
hub-market-dispute = Открыть спор
hub-market-point-plan = План стены
hub-market-point-anchor = Угловая бочка
hub-market-point-width = Бочек в ширину
hub-market-point-height = Бочек в высоту
hub-market-point-prefix = Префикс меток
hub-market-point-verify = Проверить постройку
hub-market-barrel-here = Бочка на месте
hub-market-barrel-gone = Бочки здесь нет

hub-market-disabled-mode = В том режиме хранения, который выбрал сервер, это не работает
hub-market-no-cells = Свободных бочек для этого лота не осталось
hub-market-fill-expired = Срок закладки этого лота истёк
hub-market-not-stocked = В бочке не то, что обещает лот
hub-market-lot-gone = Этот лот больше не продаётся
hub-market-packs-gone = Порций осталось меньше, чем вы просите
hub-market-trade-banned = Торговля для вас сейчас закрыта
hub-market-lot-limit = У вас уже столько лотов, сколько разрешает сервер
hub-market-point-full = На этом пункте уже лежит столько вашего, сколько можно
hub-market-cell-taken = Эту бочку заняли, пока вы выбирали
hub-market-cart-claimed = Выдача уже идёт
hub-market-cell-claimed = Эту бочку уже занял другой пункт
hub-market-barrel-missing = Там, где план обещает бочку, её нет
admin-hub-set-market-pickup-days = Дней на то, чтобы забрать оплаченное
hub-market-mine-badge = Моё
hub-market-save-wall = Сохранить стену
hub-market-cancel = Отмена
hub-market-take-down = Снять лот
hub-market-item-search = Поиск предметов
hub-market-item-none = Предметы не нашлись
hub-market-custom-name = Своё название
hub-market-custom-name-hint = Шалкер еды
hub-market-description = Что внутри
hub-market-description-hint = Хлеб, морковь и золотые яблоки
hub-market-pack-size = Предметов в порции
hub-market-pack-count = Сколько порций продаём
hub-market-pack-price = Цена одной порции
hub-market-points-hint = Бочки строят игроки, а регистратор вносит сюда готовые стены
hub-market-points-empty = Пунктов хранения пока нет
hub-market-point-new = Новый пункт
hub-market-point-code = Короткий код
hub-market-point-name = Название
hub-market-point-world = Мир
hub-market-point-where = Где стоит
hub-market-point-facing = Куда смотрит стена
hub-market-point-no-walls = Стены ещё не внесены
hub-market-wall-new = Добавить стену
hub-market-cells-free = Свободно бочек
hub-market-wall-cells = Бочек: { $n }
hub-market-lot-yours = Ваш лот
hub-market-i-filled = Я разложил
hub-market-total = Итого
hub-market-seller = Продавец
hub-market-escrow-note = Сервер держит оплату у себя, пока вы не заберёте товар.
hub-market-state-stocking = Ждёт товара
hub-market-state-sold-out = Распродан
hub-market-state-cancelled = Снят
hub-market-state-expired = Истёк
hub-market-cell-put = положить сюда
hub-market-cell-done = уже лежит
hub-market-cell-sold = продано, ждёт покупателя
hub-market-cell-missing = бочки нет
hub-money-card-default = Основная карта
hub-market-pay-from = Платить с
hub-market-payout-to = Выручка приходит на
hub-market-handover = Как получить
hub-market-checkout-title = Оформление заказа
hub-market-left-of = осталось { $left }
hub-market-cart-gone = { $items }: больше не продаётся
hub-market-cart-trimmed = { $items }: порций осталось меньше, чем вы просили
hub-market-pickup = Заберу сам
hub-market-pickup-hint = Адреса бочек придут вместе с заказом
hub-market-delivery = Доставка
hub-market-delivery-soon = Сервис курьеров скоро появится
hub-market-cart-remove = Убрать
hub-market-wall-colour = Цвет стены
hub-market-freeze = Закрыть приём
hub-market-unfreeze = Открыть снова
hub-market-vacate-days = Сколько дней продавцам на то, чтобы забрать товар?
hub-market-point-frozen = Пункт не принимает новые лоты. То, что лежит, ждёт выкупа.
hub-market-cells-waiting = ждут товара
hub-market-cells-stocked = с товаром
hub-market-cells-sold = продано, ждёт покупателя
hub-market-cell-free = свободна
hub-market-cell-busy = занята
hub-market-edit = Изменить
hub-market-save = Сохранить
hub-market-edit-point = Изменить пункт
hub-market-edit-wall = Изменить стену
hub-market-wall-locked = В стене лежит товар, поэтому меняются только подпись и цвет. Закройте приём и дождитесь, пока она опустеет.
hub-market-wall-drop-sure = Убрать эту стену вместе с её бочками?
hub-market-tab-all = Всё подряд
hub-market-tab-mine = Мои товары
hub-market-orders = Покупки
hub-market-orders-empty = Вы пока ничего не покупали
hub-market-mine-empty = Вы пока ничего не продаёте
hub-market-to-cart = В корзину
hub-market-in-cart = В корзине
hub-market-cart = Корзина
hub-market-cart-empty = Корзина пуста
hub-market-cart-empty-text = Добавьте что-нибудь с рынка и оплатите всё разом.
hub-market-cart-clear = Очистить
hub-market-checkout = Заказать всё
hub-market-some-gone = Часть лотов кончилась и убрана из корзины
hub-market-sold-of = продано { $sold } из { $all }
hub-market-manage = Управление
hub-market-where-to-take = Где забрать
hub-market-buy-for = Купить за { $sum }
hub-market-bought-from = куплено у { $who }
hub-market-sold-to = продано игроку { $who }
hub-market-order-paid = оплачено, ждёт получения
hub-market-order-collected = забрано
hub-market-order-delivering = в пути
hub-market-order-delivered = доставлено
hub-market-order-settled = закрыто
hub-market-order-refunded = деньги возвращены
hub-market-order-disputed = идёт спор
hub-market-side-bought = Мои покупки
hub-market-side-sold = Продано
hub-market-sales-empty = У вас пока ничего не купили

# ── Доставка ────────────────────────────────────────────────────────────────
nav-hub-delivery = Доставка
admin-hub-feature-delivery = Доставка
admin-hub-feature-delivery-hint = Любой игрок может взять оплачиваемый рейс и отвезти покупку заказчику
admin-hub-settings-delivery = Доставка
admin-hub-set-delivery-base = Плата за рейс
admin-hub-set-delivery-per-step = Плата за отрезок пути
admin-hub-set-delivery-step = Длина отрезка в блоках
admin-hub-set-delivery-fee-flat = Постоянное удержание с рейса
admin-hub-set-delivery-far = Дальше этого курьер виден приблизительно
admin-hub-set-delivery-near = Ближе этого покупатель видит точные координаты
admin-hub-set-delivery-bundle = Минут, пока корзина остаётся одним рейсом
admin-hub-set-delivery-take-hours = Часов на доставку после взятия рейса
admin-hub-set-delivery-per-courier = Рейсов у одного курьера одновременно
hub-delivery-title = Доставка
hub-delivery-board = Свободные рейсы
hub-delivery-my-runs = Мои рейсы
hub-delivery-board-empty = Везти нечего
hub-delivery-board-empty-text = Как только кто-нибудь закажет доставку, его рейс появится здесь.
hub-delivery-mine-empty = Вы ничего не везёте
hub-delivery-mine-empty-text = Возьмите рейс с доски, и товар появится здесь.
hub-delivery-take = Взять
hub-delivery-take-all = Взять все
hub-delivery-take-one = Взять этот
hub-delivery-whole-hint = Пока корзина едет одним рейсом. Позже её можно будет разобрать по частям.
hub-delivery-picked = Товар у меня
hub-delivery-handover = Передать
hub-delivery-drop = Отказаться
hub-delivery-ask-code = Спросите у заказчика код передачи
hub-delivery-collected = Уже забрано
hub-delivery-to-town = В город
hub-delivery-to-point = В пункт хранения
hub-delivery-to-spot = В точку
hub-delivery-to-person = Лично мне
hub-delivery-to-me = Лично мне
hub-delivery-pick-town = Выберите город
hub-delivery-pick-point = Выберите пункт
hub-delivery-world = Мир
hub-delivery-share-me = Показывать курьеру, где я
hub-delivery-share-me-hint = Сначала он видит вас приблизительно, точно — только вблизи.
hub-delivery-fare = Доставка
hub-delivery-counting = Считаем плату за рейс…
hub-delivery-no-quote = По этому адресу плату посчитать не удалось
hub-delivery-need-address = Выберите, куда везти
hub-delivery-your-code = Ваш код передачи
hub-delivery-courier-at = Курьер
hub-delivery-accuracy = Показано с точностью до { $blocks } блоков
hub-delivery-no-position = Курьера сейчас не видно
hub-delivery-status-offered = ждёт курьера
hub-delivery-status-taken = курьер идёт за товаром
hub-delivery-status-en_route = везёт вам
hub-delivery-status-delivered = доставлено
hub-delivery-status-failed = не доставлено
hub-delivery-status-cancelled = отменено
hub-delivery-range-far = далеко
hub-delivery-range-near = приближается
hub-delivery-range-here = совсем рядом
hub-market-delivery-hint = Курьер привезёт заказ за плату
hub-market-delivery-off = На этом сервере службы курьеров нет
hub-market-goods = Товар
hub-market-order = Заказ
hub-market-status = Состояние
hub-market-dispute-open = Открыть спор
hub-review-title = Оставить отзыв
hub-review-about-seller = О продавце
hub-review-about-buyer = О покупателе
hub-review-about-courier = О курьере
hub-review-text = Что было хорошо, а что нет
hub-review-send = Отправить
hub-review-thanks = Спасибо
hub-review-nobody = По этой сделке оценивать некого
admin-hub-set-delivery-fee = Доля сервиса с платы за рейс, процент
admin-hub-set-delivery-payee = Счёт, куда идёт доля с доставки
hub-market-what-now = Что дальше
hub-delivery-no-town = Вы пока не гражданин ни одного города
hub-delivery-drop-off = Положить в ячейку
hub-delivery-put-here = Положить посылку сюда
hub-delivery-parcel-here = Посылка ждёт вас
hub-delivery-parcel-waiting = Курьер ещё не привёз
admin-hub-set-delivery-payee-hint = «Оставлять в банке» — доля уйдёт на общий счёт сборов. Свой счёт нужен, когда службу доставки держит не сервер, а город или гильдия.
admin-hub-set-ad-payee-hint = «Оставлять в банке» — деньги уйдут в казну, то есть уменьшат долг банка, а не достанутся кому-то.
admin-hub-set-community-payee-hint = «Оставлять в банке» — деньги уйдут в казну, то есть уменьшат долг банка, а не достанутся кому-то.
court-kind-trade = Спор по сделке
court-trade-subject = О чём спор
court-trade-goods = Товар
court-trade-packs = Порций
court-trade-price = За порцию
court-trade-total = Уплачено
court-trade-bought = Куплено
court-trade-escrow = Оплата стоит на счёте сделок и не двигается до вердикта. Иск удовлетворён — деньги вернутся покупателю, отклонён — уйдут продавцу.
cabinet-light-title = Облегчённый режим
cabinet-light-hint = Выключает анимированный фон. Хранится для этого устройства, а не для учётной записи: что тяжело ноутбуку, легко настольной машине.

# Модули
nav-group-modules = Модули
nav-admin-modules = Модули
admin-modules-title = Модули
admin-modules-subtitle = Расширения, установленные в этот инстанс
admin-modules-install-hint = Манифест, код, мини-апп и локали одним файлом. Или нажмите, чтобы выбрать.
admin-modules-install-first = Перетащите сюда пакет .noromod
admin-modules-install-more = Установить ещё модуль
admin-modules-installed = Модуль установлен
admin-modules-list-title = Установленные
admin-modules-empty = Модулей пока нет
admin-modules-empty-hint = Перетащите сюда пакет .noromod, чтобы добавить первый
admin-modules-state-running = работает
admin-modules-state-broken = не запустился
admin-modules-state-off = выключен
admin-modules-scope-instance = весь инстанс
admin-modules-scope-server = по сборкам
admin-modules-enabled = Включён
admin-modules-stats-title = За сутки
admin-modules-stats-hint = По журналу вызовов. Медиана и хвост, а не среднее: один вызов на пять секунд теряется среди тысячи быстрых.
admin-modules-stats-total = вызовов
admin-modules-stats-failures = сбоев
admin-modules-stats-p50 = медиана
admin-modules-stats-p95 = 95-й процентиль
admin-modules-stats-slowest = самый долгий
admin-modules-stats-none = Ещё ничего не вызывалось
admin-modules-data-title = Что хранит
admin-modules-data-hint = Те же ключи, которые модуль читает своим хранилищем.
admin-modules-data-none = Модуль ничего не хранит
admin-modules-data-prefix = Отбор по началу ключа
admin-modules-versions-title = Версии
admin-modules-versions-hint = Откат — это переустановка архивного пакета со всеми проверками загрузки. Миграции назад не отыгрываются.
admin-modules-versions-current = сейчас
admin-modules-versions-rollback = Откатить
admin-modules-versions-rolled-back = Версия возвращена
admin-modules-versions-none = Только та версия, что стоит сейчас
admin-modules-servers-title = Где работает
admin-modules-servers-hint = Модуль объявлен для отдельных сборок. Он видит события и экраны только тех, что выбраны здесь.
admin-modules-servers-none = Ни одной не выбрано — модуль установлен и простаивает
admin-modules-servers-placeholder = Выберите сборки
admin-modules-servers-saved = Сборки сохранены
admin-modules-caps-title = Что модулю разрешено
admin-modules-caps-hint = Манифест просит, решаете вы. Невыданное модуль получит отказом при вызове.
admin-modules-caps-none = Модуль ничего не просит
admin-modules-cap-store = своё хранилище ключей
admin-modules-cap-db = своя схема в базе
admin-modules-events-title = События, на которые подписан
admin-modules-events-none = Подписок нет
admin-modules-calls-title = Журнал вызовов
admin-modules-calls-none = Вызовов пока не было
admin-modules-danger-title = Удаление модуля
admin-modules-danger-hint = Вместе с ним уйдут его схема и данные. Отменить это нельзя.
admin-modules-delete = Удалить
admin-modules-delete-confirm = Модуль, его схема и все данные будут удалены.
admin-modules-deleted = Модуль удалён
admin-modules-app-failed = Мини-апп не загрузился
cabinet-module-missing = Модуль недоступен
cabinet-module-missing-hint = Он выключен или у вас нет к нему доступа
admin-modules-about = О модуле
admin-modules-declares = Что модуль объявил
admin-modules-routes-title = Ручки
admin-modules-tasks-title = По расписанию
admin-modules-settings-title = Настройки
admin-modules-settings-saved = Настройки сохранены
admin-modules-save = Сохранить
admin-modules-cancel = Отмена
admin-modules-dev-action = Режим разработки
admin-modules-dev-badge = разработка
admin-modules-dev-title = Подключить модуль из каталога
admin-modules-dev-hint = Мастер будет читать модуль с диска и перезагружать его при изменении файлов — без пересборки пакета.
