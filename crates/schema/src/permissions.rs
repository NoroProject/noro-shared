...
pub const TOWN_MANAGE: &str = "manage";
pub const TOWN_MARK: &str = "mark";

/// Право распоряжаться городами сервера: одобрять заявки, заводить город
/// руками, менять границы и лимиты, распускать.
///
...
///
/// `mark` — ставить на карту метки от лица сервера: спавн, торговые площадки.
/// Отдельно от `manage`, потому что метку рисуют чаще, чем правят границы, и
/// доверить это можно шире.
